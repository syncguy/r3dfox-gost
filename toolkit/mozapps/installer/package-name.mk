...
PKG_BASENAME = $(MOZ_PKG_APPNAME)-v$(MOZ_PKG_VERSION).$(MOZ_PKG_PLATFORM)
endif
PKG_PATH =
SDK_PATH =
...
PKG_LANGPACK_BASENAME = $(MOZ_PKG_APPNAME)-v$(MOZ_PKG_VERSION).$(AB_CD).langpack
endif
LANGPACK = $(PKG_LANGPACK_PATH)$(PKG_LANGPACK_BASENAME).xpi
PKG_SRCPACK_BASENAME = source
PKG_BUNDLE_BASENAME = $(MOZ_PKG_APPNAME)-v$(MOZ_PKG_VERSION)
PKG_SRCPACK_PATH =
